...
const CreateProduct = (props) => {
  ...
  const handleInputTagOnChange = (value, index) => {
    console.log("handleInputTagOnChange");
  ...
  let saveProduct = () => {
    ...
    var jqxhr = $.post("/product/create/", product, function (response) {
      if (response.status == "success") {
        alert("product saved. Browse All products");
      } else {
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                {productVariants.map((element, index) => {
                  // console.log("element.option", element.option, "index", index);
                  return (
